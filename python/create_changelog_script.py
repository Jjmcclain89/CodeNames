#!/usr/bin/env python3
"""
Script to create CHANGELOG.md for the Codenames Web App project
"""
...
-->"""
    ...
    print("✅ CHANGELOG.md created successfully!")
    print("📁 File location:", os.path.abspath('CHANGELOG.md'))
    print("\n📝 Next steps:")
    print("   1. Review the file to make sure it looks correct")
    print("   2. Add it to git: git add CHANGELOG.md")
    print("   3. Commit: git commit -m 'Add initial CHANGELOG.md'")
